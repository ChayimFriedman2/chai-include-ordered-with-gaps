...
module.exports = function(chai, utils) {
  ...
  function indexableIncludesWithGaps(actual, expected) {
    const comparer = utils.flag(this, 'deep') ? utils.eql : strictEqual;
    let actualIndex = 0,
      expectedIndex = 0;
    ...
    this.assert(
      ...
      'expected #{this} to ' +
        (utils.flag('deep') ? 'deep ' : '') +
        'include values of #{exp}, ordered, possibly with gaps',
  ...
  Assertion.addMethod('gaps', function(subset) {
    indexableIncludesWithGaps.call(this, this._obj, subset);
  });
};
